...
<body>
   <div id="box1">
      ...
      <br>
      <hr class="line">
      <form id="form" action="InsertProducer.do" method="post">
         <h2>이메일</h2>
         ...
         <h2>상호명</h2>
         <div>
         	<input id="nickSector" type="text" name="storename">
         	<p id="p5" style="display:none"></p>
         </div>
         <h2>사업자 등록번호</h2>
         <div>
         	<input id="storeid" type="text" name="storeid">
         	<p id="p6" style="display:none"></p>
         </div>
         <br>
         <input id="sign" type="button" value="판매가 입점 신청하기">
      </form>
      ...
      <script type="text/javascript">
         ...
         let emails='${reProducerEmails}';
         let result=emails.slice(1,emails.length-1);
         let resultArr=result.split(", ");
         
         
         let nicknames='${reProducerStoreName}';
         ...
         let sids='${reProducerStoreId}';
         let sid=sids.slice(1,sids.length-1);
         let sidArr=sid.split(", ");         
         let storeid=document.getElementById("storeid");
         let sidPossible=false;
            ...
            if(value=="self"){
               ...
               if(emailFront.value==""){
                  ...
                  for(var i=0;i<resultArr.length;i++){
                     if(str==resultArr[i]){
                        p2.innerHTML="이미 판매자 입점 신청된 이메일입니다.관리자 승인을 기다려 주세요";
                        emailFront.style.border="1px solid red";
                        emailBack2.style.border="1px solid red";
                        authority.disabled=true;
                        break;
         ...
         emailFront.addEventListener("keyup",function(){
            ...
            if(value=="notproper"){
               ...
               if(value=="self"){
                  ...
                  for(var i=0;i<resultArr.length;i++){
                     if(str==resultArr[i]){
                        p2.innerHTML="판매자 입점 신청된 이메일입니다.관리자 승인을 기다려주세요";
                        emailFront.style.border="1px solid red";
                        emailBack1.style.border="1px solid red";
                        authority.disabled=true;
                        break;
       ...
       function sendemail(){
        ...
        check.addEventListener("click",function(){
         ...
         storeid.addEventListener("keyup",function(){
            
            if(storeid.value==""){
               storeid.style.border="1px solid black";
            ...
            for(var i=0; i<sidArr.length;i++){
               if(storeid.value==sidArr[i]){
                  storeid.style.border="1px solid red";
                  p6.style.display="block";
                  p6.innerHTML="이미  입점 신청된 사업자등록 번호입니다.";
                  sidPossible=false;
                  break;
               }
               else{
                  storeid.style.border="1px solid green";
                  p6.style.display="block";
                  p6.innerHTML="입점 신청 가능한 사업자등록 번호입니다.";
                  sidPossible=true;
               }
            }   
            }
         ...
         sign.addEventListener("click",function(){
            if((emailPossible==true)&&(nickPossible==true)&&(passPossible==true)&&(sidPossible==true)){
               form.submit();
            }
            else{
